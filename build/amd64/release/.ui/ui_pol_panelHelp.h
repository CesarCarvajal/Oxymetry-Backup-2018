...
"\n"
"Please go to the button \"Configure\" and click on the button \"Load "
                        "Configuration\". Then select the appropriate configuration file with extension \".csar\".\n"
"\n"
"\n"
...
"\n"
"After the configuration is loaded or created, a "
                        "table with the measurement entries will be displayed, as well as the saving options of Raw Data and FFT Profiles. Additionally, the syringe pumps software neMESYS User Interface will be open automatically.\n"
"\n"
...
"\n"
"** At least one type of file to"
                        " save has to be selected, otherwise the measurement data could be lost.\n"
"\n"
"\n"
...
"\n"
"** Please consider that in general very large numb"
                        "er of spectra or integration time will lead to larger measurement intervals, which could also overload the computer in use.\n"
"\n"
"\n"
...
"\n"
"Please check that the spectrometer is not in use in another function a"
                        "t that time. Also a configuration profile is required to start the measurements. (See 2).\n"
"\n"
"\n"
...
"\n"
"During this phase, the raw signal"
...
"\n"
"** Remember that raw data has the name form XXC1_XXC2_XXms_XXHz_XX.CS/.TXT and the FFT data has the name form XXC1_XXC2_XXms_XXH"
                        "z_XX_FFT.txt.\n"
"\n"
"\n"
