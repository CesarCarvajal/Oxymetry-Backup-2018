...
"\n"
"Dur"
                        "ing the calibration phase, first the plot of the raw signal is shown for an interval of time, then the FFT data is calculated and showed after processing. This cycle is repeated until the user stops the calibration.\n"
"\n"
"\n"
...
"\n"
"** Please consider that in general very large number of spectra or integration time will lead to "
                        "larger measurement intervals, which could also overload the computer in use.\n"
"\n"
"\n"
...
"\n"
"\n"
"4.2 -> How do I perform a measurem"
                        "ent?\n"
"\n"
...
"\n"
"During this phase, the raw signal is shown for a longer period of time. Then the FFT is performed when the time interval is complete. This is to avoid overloading of the s"
                        "ystem during the long term measurements. A history of the average signals can be seen in the plot \"Average Signal\". Also the plot of \"Prediction\" will be loaded by demand, which will show after each time interval the correspoding result for the linear regression algorithm.\n"
"\n"
"\n"
"\n"
"-> 5. OTHERS\n"
...
"\n"
"To change the wavelength in the side panel plot FFT Intensity, click the"
                        " label of the wavelength number and select the desired one. This change will remain during all the calibration or measurements. This parameter can be changed at any time during the calibrations or the measurements.\n"
"\n"
"\n"
"\n"
"-> 6. SOFTWARE ISSUES ?\n"
...
"\n"
"Sometimes it happens when the calibration is stopped and the spectrometer was busy measuring. This interruption is most of the times catched and fixed. If this happens, you could restart the cali"
                        "bration to re draw the plots or click in the option \"Clear All\", remember that this last will also remove any other loaded configuration.", Q_NULLPTR));
    } // retranslateUi
