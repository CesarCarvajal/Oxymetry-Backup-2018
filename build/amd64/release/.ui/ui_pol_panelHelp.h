...
"+ The 2 Plots in the"
                        " tab Setup Status show the current temperature fo the setup and the measured FFT peaks.\n"
...
"\n"
"Please go to the button \"Configure\" and click on the button \"Load Configuration\". Then select the appropriate configuration file with extension \".csa"
                        "r\".\n"
"\n"
"\n"
...
"\n"
"After the configuration is loaded or created, a table with the measurement entries will be displayed, as well as the saving options o"
                        "f Raw Data and FFT Profiles. Additionally, the syringe pumps software neMESYS User Interface will be open automatically.\n"
"\n"
...
"\n"
"Please click on the des"
                        "ired parameter and set the new value.\n"
"\n"
...
"\n"
"During the calibration phase, first "
                        "the plot of the raw signal is shown for an interval of time, then the FFT data is calculated and showed after processing. This cycle is repeated until the user stops the calibration.\n"
"\n"
"\n"
...
"\n"
"** Please consider that in general very large number of spectra or integration time will lead to larger measurement intervals, whi"
                        "ch could also overload the computer in use.\n"
"\n"
"\n"
...
"\n"
"Please check that the spectrometer is not in use in another function at that time. Also a configuration profile is required to start the measurements."
                        " (See 2).\n"
"\n"
"\n"
...
"\n"
"During this phase, the raw signal is shown for a longer period of time. Then the FFT is performed when the time i"
                        "nterval is complete. This is to avoid overloading of the system during the long term measurements. A history of the average signals can be seen in the plot \"Average Signal\". Also the plot of \"Prediction\" will be loaded by demand, which will show after each time interval the correspoding result for the linear regression algorithm.\n"
"\n"
...
"\n"
"Click on"
                        " \"Save Graphs\" and select the folder where the PDF files will be saved. One per each plot of Compensation and FFT profile.\n"
"\n"
"\n"
...
"\n"
"6.2 -"
                        "> Why the plots are disturbed sometimes after stopping the calibration?\n"
"\n"
