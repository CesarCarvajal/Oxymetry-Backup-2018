...
""
                        "\n"
"The user interface will provide some GUI elements when they are required according to the user selection. For example, the plot \"Prediction\" will be displayed only during the \"Measurements\" phase of the software. Also, the \"Configuration\" phase has some additional tables and option shown when required.\n"
"\n"
"\n"
"\n"
"->  2. CONFIGURATION\n"
...
"\n"
"Please go to the button \"Configure\" and click on the button \"Load Configuration\". Then select the appropriate configuration file with extension \".txt\".\n"
"\n"
"\n"
...
"\n"
"\n"
"2.3 -> What is created from the option "
...
"\n"
"\n"
"2.4 -> What else is saved in this folder?\n"
"\n"
...
"\n"
"\n"
"2.6 -> What the table \"Measurement Profile\" contains?\n"
"\n"
"This table contains the time intervals between the "
                        "measurements and the file name saved for each time interval.\n"
"\n"
"\n"
...
"\n"
"Please go to the button \"Calibrate\". If no configuration profile is loaded or created (see 2), the interface will ask to run a \"Free Calibration\" or to \"Load Configuration\". Cli"
                        "ck in the desired type of calibration (See 3.2).\n"
"\n"
"\n"
"3.2 -> What is a Free Calibration?\n"
"\n"
"With this option, default values for the configuration will be loaded and the calibration will allow changes in the spectrometer settings only. This option is just a preview of the actual state of the setup.\n"
"\n"
"\n"
"3.3 -> What happens if a Configuration is loaded before starting the calibration?\n"
"\n"
"If there is a configuration already loaded in the interface, the calibration will start directly by taking the parameters of the previously  loaded or created configuration.\n"
"\n"
"\n"
"3.4 -> How to change values of the configuration?\n"
"\n"
"This option of only available during the calibration phase. The user can change the spectrometer integration time, number of averages and auto adjust by just doing click in the corresponding label and giving the corresponding desired value. The number of spectra and frequency can be modified by doing click in the corresponding cell of its table and pressin"
                        "g the key \"Enter\" after doin gthe change. With this action, the changes will be accepted by the interface. If no \"Enter\" is pressed, then the value will return to its original value automatically.\n"
"\n"
"** The interface will restart the calibration automatically each time a parameter is modified.\n"
"\n"
"\n"
"3.5 -> Is the configuration profile modified during the calibration?\n"
"\n"
...
"\n"
"\n"
"3.6 -> When can I vary the spectrometer parameters?\n"
"\n"
"Only during the calibration phase, this to avoid changes for example when the measurement is running automatically.\n"
"\n"
"\n"
"3.7 ->   How long are the intervals in between the spectrometer measurements during the calibration?\n"
"\n"
"It depends on the actual settings, it can go up to minutes f"
                        "or large integration times, number of spectra or number of averages.\n"
"\n"
"\n"
"3.8 -> How the plots are arranged?\n"
"\n"
...
"\n"
"\n"
"3.11 -> Why I can see the Live Raw data only a few seconds?\n"
"\n"
...
"\n"
"\n"
"3.12 -> What are those bars at the bottom when doing the calibration?\n"
"\n"
...
"\n"
"\n"
"4.1 -> Why I can't start a measurement?\n"
"\n"
"Please check that the spectrometer is not in use in another function at that"
                        " time. Also a configuration profile is required to start the measurements. (See 2).\n"
"\n"
"\n"
"4.2 -> How I do perform a measurement?\n"
"\n"
...
"\n"
"During this phase, the raw signal is sh"
...
"\n"
"5.3 -"
                        "> How can I change the wavelength of the FFT plot?\n"
"\n"
