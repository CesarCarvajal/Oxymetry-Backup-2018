...
public:
    ...
    void retranslateUi(QDialog *PanelAbout)
    {
        ...
        plainTextEdit_changelog->setPlainText(QApplication::translate("PanelAbout", "Version 0.8: (14.11.2018)\n"
...
"+ Load the folder containing the .FFT files measured with the set"
                        "up.\n"
...
"+ Automatic adjustement of axis fo"
                        "r 3D plots.\n"
"\n"
...
"+ The user can crea"
                        "te up to 2 impurities plus the glucose concentration.\n"
...
"+ Automatic adjustement of plots ac"
                        "cording to all new settings.\n"
...
"+ Additional information (dynamic dark co"
                        "rrection enabled, time and date, ...) is now stored within the saved spectra\n"
"\n"
"Version 0.2:\n"
"\n"
