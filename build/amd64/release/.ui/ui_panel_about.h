...
public:
    ...
    void retranslateUi(QDialog *PanelAbout)
    {
        ...
        label_title->setText(QApplication::translate("PanelAbout", "Oxymetry 0.7.1", Q_NULLPTR));
        ...
        plainTextEdit_changelog->setPlainText(QApplication::translate("PanelAbout", "Version 0.7.1: (30.07.2018)\n"
...
"+ The user"
                        " can now Normalize the measurements in counts per second.\n"
...
"+ The user can create up to 2 impurities"
                        " plus the glucose concentration.\n"
...
"+ Fluidic t"
                        "oolkit now supports roller pump driven by stepper motor\n"
...
"+ Automatic adjustement of plots according to all new se"
                        "ttings.\n"
...
"+ Additional information (dynamic dark correction enabled"
                        ", time and date, ...) is now stored within the saved spectra\n"
"\n"
"Version 0.2:\n"
"\n"
