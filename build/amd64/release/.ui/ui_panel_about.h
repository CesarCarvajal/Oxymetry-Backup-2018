...
public:
    ...
    void retranslateUi(QDialog *PanelAbout)
    {
        ...
        label_title->setText(QApplication::translate("PanelAbout", "Oxymetry 0.7", Q_NULLPTR));
        ...
        plainTextEdit_changelog->setPlainText(QApplication::translate("PanelAbout", "Version 0.7: (15.06.2018)\n"
...
"+ Auto change of name of files in measurement profile when changes are made during calibratio"
                        "n.\n"
...
"+ Autoadjust of Plot X and Y axis according to "
                        "the ploted data.\n"
...
"+ File and folder creation when polarimetric measurem"
                        "ent starts\n"
"\n"
...
"\n"
"* Fixed a bug that prevented data e"
                        "xport\n"
